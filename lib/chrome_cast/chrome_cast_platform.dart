...
import 'package:smart_dev_flutter_cast/chrome_cast/method_channel_chrome_cast.dart';

/// The interface that platform-specific implementations of `flutter_cast_video` must extend.
abstract class ChromeCastPlatform {
  static final MethodChannelChromeCast _instance = MethodChannelChromeCast();
